...
slide-number: true
footer: |
  **4^th^ Workshop on Methodologies for Official Statistics**
...
- Insee's journey to open-source adoption
- Open-source adoption motivators
- The main challenge we faced
- The challenges we're still facing

Find these slides: <https://rlesur.github.io/istat-meth4os-2025>
...
## An effective decrease of SAS users
...
## Open-source languages adoption
